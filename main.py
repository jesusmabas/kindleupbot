...
"""
    ...
    async def handle_document(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            # No borramos el archivo temporal si es un PDF, porque su ciclo de vida
            # se gestiona en handle_callback después de que el usuario interactúa
            # con los botones. Para el resto de formatos, la limpieza se hace aquí.
